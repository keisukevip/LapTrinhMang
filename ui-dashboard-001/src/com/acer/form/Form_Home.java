...
public class Form_Home extends javax.swing.JPanel {
    ...
    public Form_Home(String output) {
//        Gson gson = new Gson();
//        Type listType = new TypeToken<List<CongViec>>(){}.getType();
//        List<CongViec> congViecList = gson.fromJson(output, listType);
        initComponents();
        //  add row table
...
//        table.addRow(new Object[]{output[1], output[2], output[3], output[4], StatusType.fromString(output[5])});
